# Azure Virtual Network Module for Multi-Cloud DR System
...
# Network Security Group for Application VMs
...
resource "azurerm_network_security_group" "db" {
  ...
  security_rule {
    ...
    source_address_prefixes    = azurerm_subnet.private_app.address_prefixes
    destination_address_prefix = "*"
  }
